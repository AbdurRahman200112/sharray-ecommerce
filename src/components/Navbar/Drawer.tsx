...
export default function Drawer({
  ...
  const placeholderImage = '/placeholder-logo.svg'; // Placeholder image path
      ...
      >
        <div className="flex flex-col justify-start gap-10 h-full" style={{ color: textColor }}>
          ...
          <div className="w-full flex justify-center items-center">
            <Image
              src={imageError ? placeholderImage : `${BASE_IMG}/${logo}`}
              width={65}
              height={65}
              loading="lazy"
              placeholder="blur"
          ...
          <div className="flex items-end justify-center mt-auto">
            ...
            >
              <img className="w-7" src="/esite_logo.svg" alt="eSITE Logo" />
